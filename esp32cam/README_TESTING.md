...
curl -X POST http://localhost:8080/props \
  -H 'Content-Type: application/json' \
   -d '{"name":"test_cam","room_id":"bedroom","location":"upstairs","cam_mode":"room","poll_interval":5.0}'
```
...
curl -X POST http://192.168.1.100/props \
  -H 'Content-Type: application/json' \
   -d '{"name":"front_door","room_id":"entrance","location":"front-porch","cam_mode":"door","poll_interval":15.0}'
```
